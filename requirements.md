...
**S.2-03**: **Propagate Sound** The system must calculate audio occlusion in real-time. If a wall exists between the Source and Listener, apply a Low-Pass Filter and volume attenuation curve defined in the Wwise project.
